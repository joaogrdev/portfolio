                    ...
                    {socialItems.map((s, i) => (
                      <li key={s.label + i} className="sm-socials-item">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-[1.2rem] font-medium text-primary font-contrast"
                        >
                          {s.label}
                        </a>
                      </li>
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: ${background}; height: 100vh; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
